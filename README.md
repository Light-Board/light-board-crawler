...
6. 빠르게 검색 결과를 가져오기 위해 DB 활용하고, 데이터를 가져왔는데 '어떻게 갱신하지'
...
- https://github.com/Light-Board/light-board-crawler
- 팀레포 : https://github.com/Light-Board
- 같이 작고 하찮을 수 있지만, 소중한 오픈소스 만드실 분! 메일 주세요 :)
